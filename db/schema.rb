...
ActiveRecord::Schema.define(version: 20160615191845) do
  ...
  add_index "stations_routes", ["station_id", "route_id"], name: "index_stations_routes_on_station_id_and_route_id", unique: true, using: :btree
